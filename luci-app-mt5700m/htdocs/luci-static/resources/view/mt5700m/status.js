...
return view.extend({
	...
	styleNode: function() {
		...
		'.mt5700m-webui-cta{display:flex;align-items:center;gap:14px;padding:14px 18px;margin-bottom:12px;border-radius:14px;text-decoration:none;color:#fff;background:linear-gradient(135deg,#1264d8 0%,#087eae 55%,#07988e 100%);box-shadow:0 10px 26px rgba(14,92,155,.18);transition:filter .15s ease}.mt5700m-webui-cta:hover{filter:brightness(1.05)}.mt5700m-webui-cta-icon{display:inline-flex;align-items:center;justify-content:center;width:38px;height:38px;border-radius:10px;background:rgba(255,255,255,.18);font-size:20px;flex:none}.mt5700m-webui-cta-text{flex:1;display:flex;flex-direction:column;gap:2px}.mt5700m-webui-cta-text strong{font-size:15px;font-weight:750}.mt5700m-webui-cta-text span{font-size:10px;color:rgba(255,255,255,.82);line-height:1.4}.mt5700m-webui-cta b{font-size:22px;font-weight:700}',
